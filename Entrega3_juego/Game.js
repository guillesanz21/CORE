...
class Game {
  ...
  constructor() {
    ...
    this.score = 0; // Indica la puntuación del personaje principal
  }
  ...
  endGame() {
    ...
    let gameOver = new Entity(
      ...
      this.height / 4,
      0,
      this.player.lives > 0 ? YOU_WIN_PICTURE : GAME_OVER_PICTURE
    );
    gameOver.render();
  }
  ...
  render() {
    ...
    let scoreli = document.querySelector("#scoreli");
    let livesli = document.querySelector("#livesli");
